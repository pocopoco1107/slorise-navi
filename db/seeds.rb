...
# -----------------------------------------------
# 2. Shops (~15)
# Dev-only demo shops (ptown_shop_id: nil).
# Production shops are imported from DMMぱちタウン with ptown_shop_id set.
# These English slugs (e.g. "maruhan-shinjuku") do not exist in production.
# -----------------------------------------------
...
# -----------------------------------------------
# 3. Machine Models (~30)
# Dev-only demo machines with English slugs (e.g. "smart-hokuto").
# Production machines are imported from DMMぱちタウン via rake ptown:import_machines
# and use Japanese slugs generated by normalize_slug (e.g. "スマスロ北斗の拳").
# These seed slugs will not conflict with ptown-imported data.
# -----------------------------------------------
MACHINES = [
  # スマスロ (AT機)
