...
### 4-2. AI SNS情報収集 (段階的導入)
- [ ] **Step 1**: Google検索で「[機種名] 設定示唆」情報を収集 ($0)
- [ ] **Step 2**: Claude Haiku APIで要約・構造化 (月$5〜15)
  - 収集した情報から「設定示唆まとめ」を自動生成
  - 機種ページに「AI分析」セクションとして表示
- [ ] **Step 3**: X API導入 (PV増・収益化後に検討、月$200)
  - リアルタイム設定情報の自動取得
  - 店舗ごとのSNS評判スコア
...
## 優先順位ガイド
1. Phase 2-2 (投票UI改善) — サイトの核心価値を高める
2. Phase 2-3 (UI/UX改善) — 第一印象を良くする
3. Phase 3 (デプロイ) — 公開してフィードバック収集
